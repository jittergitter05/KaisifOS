    ...
    <div className="flex flex-col h-screen overflow-y-auto w-full bg-slate-900 text-slate-50">
      <header className="h-16 border-b border-slate-800 px-8 flex items-center justify-between bg-slate-900/50 backdrop-blur-md shrink-0 sticky top-0 z-50">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col"><h1 className="text-lg font-bold tracking-tight">Today's Digest</h1><p className="text-[10px] text-slate-500 uppercase tracking-widest">Scout Agent Matches</p></div>
        </div>
        <Link href="/admin/tracker" className="text-xs text-slate-400 hover:text-emerald-400 font-mono transition-colors border border-slate-800 px-3 py-1.5 rounded bg-slate-900 hover:border-emerald-500/30">&larr; Back to Tracker</Link>
      </header>
